...
namespace iRacing
{
    public class DataFeed
    {
        ...
        unsafe ITelemetry ReadVariables(iRSDKHeader header, VarHeader[] varHeaders, int requestedTickCount, bool logging)
        {
        ...
        static ITelemetry ReadAllValues(MemoryMappedViewAccessor accessor, int buffOffset, VarHeader[] varHeaders)
        {
